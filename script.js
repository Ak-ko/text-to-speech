...
function textToSpeech(data) {
    VoiceRSS.speech({
        key: 'dd4992430aaf4d75ac4ec6ff2b56e67b',
        src: data,
        hl: 'en-us',
        v: 'Rose',
        r: -1, 
...
async function getJokesFromApi() {
    const category = ["Programming", "Misc", "Dark", "Pun", "Spooky", "Chirstmas"];
    const apiUrl = `https://v2.jokeapi.dev/joke/${category[3]}?blacklistFlags=nsfw,religious,political,racist,sexist,explicit`;
    let joke = '';
    try {
